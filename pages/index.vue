    ...
    <section class="container mx-auto pt-24">
      ...
      <div class="flex">
        <div class="w-full px-56 mb-5">
          <img src="/assets/images/line-step.svg" alt="" class="w-full" />
        </div>
      </div>
      ...
      <div class="flex mt-3 -mx-6">
        ...
        >
          <div class="item">
            <figure class="item-image">
              <img
                src="/assets/images/project-thumbnail-2.jpg"
                alt=""
                class="rounded-20 w-full"
              />
            </figure>
        ...
        >
          <div class="item">
            <figure class="item-image">
              <img
                src="/assets/images/project-thumbnail-3.jpg"
                alt=""
                class="rounded-20 w-full"
              />
            </figure>
      ...
      <div class="flex mt-3 -mx-6">
        ...
        >
          <div class="item">
            <figure class="item-image">
              <img
                src="/assets/images/project-thumbnail-4.jpg"
                alt=""
                class="rounded-20 w-full"
              />
            </figure>
        ...
        >
          <div class="item">
            <figure class="item-image">
              <img
                src="/assets/images/project-thumbnail-5.jpg"
                alt=""
                class="rounded-20 w-full"
              />
            </figure>
        ...
        >
          <div class="item">
            <figure class="item-image">
              <img
                src="/assets/images/project-thumbnail-6.jpg"
                alt=""
                class="rounded-20 w-full"
              />
            </figure>
